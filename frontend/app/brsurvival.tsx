...
const CONTESTS = {
  ongoing: [
    {
      id: '1',
      title: 'ONLY HEADSHOT 🔥 SKILL/SKIN ON😎',
      gameId: '#112545',
      ...
      image: 'https://i.ytimg.com/vi/R77w-xcaxdI/maxresdefault.jpg',
      status: 'Joining Full',
      statusColor: '#4A90E2',
    },
  ],
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>BR SURVIVAL Contests</Text>
        <View style={{ width: 30 }} />
      </View>
...
export default BRSurvivalScreen;
