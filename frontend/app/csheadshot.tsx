  ...
  ongoing: [
    {
      ...
      image: 'https://i.ytimg.com/vi/rk6WkDwquWE/maxresdefault.jpg',
      status: 'Joining Full',
      statusColor: '#4A90E2',
    },
  ],
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>CS HEADSHOT Contests</Text>
        <View style={{ width: 30 }} />
      </View>
...
export default CSHeadshotScreen;
