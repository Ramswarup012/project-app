  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>{tournament?.roomId}</Text>

        <Text style={styles.label}>Room Password</Text>

        <Text style={styles.value}>{tournament?.roomPassword}</Text>

        <Text style={styles.label}>Match Date</Text>

        <Text style={styles.value}>{tournament?.matchDate}</Text>

        <Text style={styles.label}>Match Time</Text>

        <Text style={styles.value}>{tournament?.matchTime}</Text>
      </View>
    </View>
  );
}
