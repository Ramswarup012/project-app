  ...
  ongoing: [
    {
      ...
      image: 'https://tse4.mm.bing.net/th/id/OIP.1aQTOPi74KEXY04ita6QsQHaEK?rs=1&pid=ImgDetMain&o=7&rm=3',
      status: 'Joining Full',
      statusColor: '#4A90E2',
    },
  ],
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>CHALLENGE Contests</Text>
        <View style={{ width: 30 }} />
      </View>
