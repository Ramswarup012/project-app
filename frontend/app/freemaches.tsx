...
const CONTESTS = {
  ongoing: [
    {
      id: '1',
      title: 'FREE MATCHES 🔥 SKILL/SKIN ON😎',
      gameId: '#112545',
      ...
      image: 'https://i.ytimg.com/vi/4YC_-wBlJaM/maxresdefault.jpg',
      status: 'Joining Full',
      statusColor: '#4A90E2',
    },
  ],
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>FREE MATCHES Contests</Text>
        <View style={{ width: 30 }} />
      </View>
...
export default FreeMatchesScreen;
